...
const Navbar = () => {
    ...
    return (
        <FlexBetween padding="1rem 6%" backgroundColor={alt}>
            ...
            {/* Mobile Nav */}
            {!isNoneMobileScreen && isMobileMenuToggled && (
                <Box position="fixed" right="0" bottom="0" height="100%" zIndex="10" maxWidth="500px" minWidth="300px" backgroundColor={background}>
                    ...
                    {/* Menu Items */}
                    <FlexBetween display="flex" flexDirection="column" justifyContent="center" alignItem="center" gap="3rem">
